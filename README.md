...
```
***This command will give you a full, short description list on all of the functions in Easykinter!***

***Additionally, make sure to check this folder:***
```
┌─────────────────┐
|**examples/**    | <- This one!
|src/             |
...
└─────────────────┘
```
***This folder will contain many files of practical examples (that are executable .py scripts!) to better learn the library!***
--------------------------------------------------------------
### Example:
```python
import easykinter as ek
...
* ***A built in and intergrated video renderer*** for Tkinter!
* A *GIF file loader and animator* that *supports transparency*!
...
* *A great overhaul* for Tkinter's *packing systems in creating elements!*
* Easier Window and Frame creation!
* Easier GUI, Entry *and* Display elements!
* ***And a lot more!***
----------------------------------------------------------------
### Why use EasyKinter?
Because it's practical. It doesn't wanna make you wanna roll around in the floor, screaming in anger.

**A more formal explanation would be:**
...
* The devs of **python-mpv** and **libmpv-2.dll** for making the wrapper to run videos so smooth and easy to integrate!
